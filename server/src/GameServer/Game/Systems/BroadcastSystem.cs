...
/// </summary>
public class BroadcastSystem : BaseSystem<World, float>
{
    private readonly SubscriberMap _subscriberMap;

    private readonly QueryDescription _query = new QueryDescription()
        .WithAll<DirtyComponent, ZoneComponent, EntityIdComponent, PositionComponent>();

    public BroadcastSystem(World world, SubscriberMap subscriberMap) : base(world)
    {
    ...
    {
        World.Query(in _query, (ref DirtyComponent dirty, ref EntityIdComponent entityId, ref PositionComponent position) =>
        {
